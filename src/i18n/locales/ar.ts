    ...
    settings: {
        ...
        groups: {
            ...
            list: {
                ...
                propertySort: 'الفرز والتجميع حسب الخاصية',
        ...
        items: {
            ...
            propertySortKey: {
                name: 'خصائص الفرز والتجميع',
                desc: 'خصائص الواجهة الأمامية مفصولة بفواصل. تظهر كل خاصية كخيار فرز وخيار تجميع في قائمة الفرز في لوحة القائمة. هذه الخصائص لا يتم تغييرها.',
            ...
            propertySortInstructions: {
                intro: 'تظهر كل خاصية مدرجة أعلاه كخيار فرز وخيار تجميع في قائمة الفرز في لوحة القائمة. يرتب الفرز الملاحظات حسب قيمة الواجهة الأمامية، مع دمج قيم المصفوفات في سلسلة واحدة. يجمع التجميع الملاحظات التي تشترك في نفس القيمة تحت رأس واحد؛ الملاحظات التي لها قيمة قائمة تُجمع تحت القائمة الكاملة، والملاحظات التي تفتقد الخاصية تُوضع في مجموعة "بدون" في النهاية.'
            },
            ...
            groupNotes: {
                ...
                desc: 'يعرض "مخصص" الرؤوس المعرفة في الواجهة الأمامية. يجمع "التاريخ" الملاحظات حسب التاريخ. يجمع "المجلد" الملاحظات حسب المجلد. تستخدم عروض الوسوم والخصائص تجميع التاريخ عند تحديد المجلد. يتوفر التجميع حسب قيمة خاصية الواجهة الأمامية لكل عرض من قائمة الفرز في لوحة القائمة.',
                options: {
                    custom: 'مخصص',
                    date: 'التاريخ',
                    folder: 'المجلد'
