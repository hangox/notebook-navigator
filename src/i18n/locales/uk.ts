    ...
    settings: {
        ...
        groups: {
            ...
            list: {
                ...
                propertySort: 'Сортування та групування за властивістю',
                manualSort: 'Ручне сортування',
        ...
        items: {
            ...
            propertySortKey: {
                name: 'Властивості сортування та групування',
                desc: 'Розділені комами властивості frontmatter. Кожна властивість відображається як опція сортування та опція групування в меню сортування на панелі списку. Ці властивості не змінюються.',
            ...
            propertySortInstructions: {
                intro: "Кожна властивість, перелічена вище, відображається як опція сортування та опція групування в меню сортування на панелі списку. Сортування впорядковує нотатки за значенням у frontmatter, об'єднуючи значення масивів в один рядок. Групування збирає нотатки з однаковим значенням під одним заголовком; нотатки зі списковим значенням групуються за повним списком, а нотатки без цієї властивості потрапляють у кінцеву групу «Немає»."
            },
            ...
            groupNotes: {
                ...
                desc: 'Користувацьке показує заголовки, визначені у frontmatter. Дата групує нотатки за датою. Папка групує нотатки за папкою. Перегляди тегів і властивостей використовують групи за датою, коли вибрано папку. Групування за значенням властивості frontmatter доступне окремо для кожного перегляду в меню сортування на панелі списку.',
                options: {
